<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="VoteITClient.dashboard" ClientIDMode="Static" %>
                            ...
                            <div class="col-lg-12">
                                <asp:GridView ID="gvQuestions" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="false" AllowSorting="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Button" CommandName="Vote" Text="Vote" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="10%" />
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
